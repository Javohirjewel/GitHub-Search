...
import{INput, Button, SearchPanel, Info, Img, Content, Title,  Account, Profile, Title1, Title2, Follow, FT, FP, Card, Location, Tit, P} from './/style'
import './input.css'
            ...
            <Info>
                ...
                <Content>
                    <Title1>
                        ...
                        <Title2>
                            {data.created_at === null ? <div>Not awiable</div> : data.created_at}
                        </Title2>
                    </Title1>
                    < Account>
                         {'@' + data.login}
                    ...
                    <Profile>
                        {data.bio === null ? <div>Not awiable</div> : data.bio}
                    </Profile>
                    <Follow>
                        <Card>
                            <FT>
                            ...
                            <FP> 
                                {data.public_repos === null ? <div>Not awiable</div> : data.public_repos}
                            </FP>
                        </Card>
                        <Card>
                            <FT>
                            ...
                            <FP> 
                                {data.followers === null ? <div>Not awiable</div> : data.followers}
                            </FP>
                        </Card>
                        <Card>
                            <FT>
                            ...
                            <FP> 
                                {data.following === null ? <div>Not awiable</div> : data.following}
                            </FP>
                        </Card>
                    </Follow>
                    <Location>
                        <Tit>
                            ...
                            <P>
                                {data.location === null ? <div>Not awiable</div> : data.location}
                            </P>
                        </Tit>
                        <Tit>
